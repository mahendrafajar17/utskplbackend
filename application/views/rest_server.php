...
<div id="container">
    ...
    <div id="body">
        ...
        <ol>
            ...
            <li><a href="<?php echo html_escape(site_url('api/example/users/format/csv')); ?>">Users</a> - get it in CSV</li>
            ...
            <li><a href="<?php echo html_escape(site_url('api/example/users.html')); ?>">Users</a> - get it in HTML (users.html)</li>
            <li><a href="<?php echo html_escape(site_url('api/example/users/format/html')); ?>">Users</a> - get it in HTML (users/format/html)</li>
            <li><a href="<?php echo site_url('api/example/users?format=html'); ?>">Users</a> - get it in HTML (users?format=html)</li>
        </ol>

    </div>

    <p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  html_escape('CodeIgniter Version <strong>'.CI_VERSION.'</strong>') : html_escape('') ?></p>
</div>
